...
- **src/layouts/Admin.jsx** (instead of Index)
- **src/layouts/RTL.jsx**
- **src/views/RTLPage/RTLPage.jsx**
### Deleted components
- **src/layouts/Index/Index.jsx** (renamed to Admin)
...
## [1.2.0] 2018-04-16
### Bug Fixing
- Renamed `src/containers/App/App.jsx` to `src/layouts/Index/Index.jsx`
...
- Added design from Material Index by Creative Tim
